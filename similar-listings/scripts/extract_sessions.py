...
def main():
    parser = argparse.ArgumentParser(description="Extract search sessions from interaction data")
    parser.add_argument("--input", type=str, default="data/interactions.json", 
                       help="Input interactions JSON file")
    parser.add_argument("--output", type=str, default="data/sessions.json",
