...
from similar_listings.utils.data import TripletGenerator, load_sessions, load_listings, save_data
from similar_listings.utils.evaluation import print_triplet_stats


def main():
    parser = argparse.ArgumentParser(description="Generate training triplets from session data")
    parser.add_argument("--sessions", type=str, default="data/sessions.json",
                       help="Input sessions JSON file")
    parser.add_argument("--listings", type=str, default="data/listings.json",
                       help="Input listings JSON file")
    parser.add_argument("--output", type=str, default="data/triplets.json",
